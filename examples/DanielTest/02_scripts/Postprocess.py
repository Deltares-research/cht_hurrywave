...
ERA5_netcdf_files = {
    'swh': os.path.join(ERA5_data_path, data_name,'significant_height_of_combined_wind_waves_and_swell', 'NorthSea_significant_height_of_combined_wind_waves_and_swell_2023.nc'),
    'mwp': os.path.join(ERA5_data_path, data_name,'mean_wave_period', 'NorthSea_mean_wave_period_2023.nc'),
    # Add more as needed
}
