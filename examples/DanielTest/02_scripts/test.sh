...
#SBATCH -t 0-8:00
#SBATCH --output=/gpfs/work3/0/ai4nbs/hurry_wave/north_sea/04_modelruns/YearSims/hurry.out
#SBATCH --error=/gpfs/work3/0/ai4nbs/hurry_wave/north_sea/04_modelruns/YearSims/hurry.err
...
python /gpfs/work3/0/ai4nbs/hurry_wave/north_sea/02_scripts/Postprocess_LINUX_multiple.py