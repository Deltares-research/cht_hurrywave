...
parser = argparse.ArgumentParser(description="Run HurryWave model for a given year.")
parser.add_argument('--year', type=int, required=True, help='Year of the simulation (e.g., 2023)')
